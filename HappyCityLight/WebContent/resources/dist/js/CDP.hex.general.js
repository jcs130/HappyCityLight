        ...
        HexBoundary.prototype.getColorFromValue = function (value) {
            ...
            //    if (value >= 0) {
            //        var color = d3.interpolate(yellow, green); //color interpolation function
            //        var linear = d3.scale.linear().domain([0, 5]).range([0, 1]);
            //        return color(linear(value));
            //    } else {
            //        var color = d3.interpolate(red, yellow); //color interpolation function
            ...
            var color = d3.interpolate(negaColor, posiColor); //color interpolation function
