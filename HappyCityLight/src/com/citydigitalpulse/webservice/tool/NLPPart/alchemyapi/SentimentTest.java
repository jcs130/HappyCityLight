package com.citydigitalpulse.webservice.tool.NLPPart.alchemyapi;
...
class SentimentTest {
    public static void main(String[] args) throws IOException, SAXException,
        ...
        AlchemyAPI alchemyObj = AlchemyAPI.GetInstanceFromString("b232c9bbb50818d45e1ecd2f14ea0bc47bdea8d1");
...
//	System.out.println(getStringFromDocument(doc));
	...
	// Extract entity-targeted sentiment from a HTML document.	
		...
		// doc =
		// alchemyObj.TextGetRankedNamedEntities("That Mike Tyson is such a sweetheart.",
		// entityParams);
		// System.out.println(getStringFromDocument(doc));
		//
		// // Extract keyword-targeted sentiment from a HTML document.
		// AlchemyAPI_KeywordParams keywordParams = new
		// AlchemyAPI_KeywordParams();
		// keywordParams.setSentiment(true);
		// doc =
		// alchemyObj.TextGetRankedKeywords("That Mike Tyson is such a sweetheart.",
		// keywordParams);
		// System.out.println(getStringFromDocument(doc));
		//
		// //Extract Targeted Sentiment from text
		// AlchemyAPI_TargetedSentimentParams sentimentParams = new
		// AlchemyAPI_TargetedSentimentParams();
		// sentimentParams.setShowSourceText(true);
		// doc = alchemyObj.TextGetTargetedSentiment("This car is terrible.",
		// "car", sentimentParams);
		// System.out.print(getStringFromDocument(doc));
		//
		// //Extract Targeted Sentiment from url
		// doc =
		// alchemyObj.URLGetTargetedSentiment("http://techcrunch.com/2012/03/01/keen-on-anand-rajaraman-how-walmart-wants-to-leapfrog-over-amazon-tctv/",
		// "Walmart",sentimentParams);
		// System.out.print(getStringFromDocument(doc));
		//
		// //Extract Targeted Sentiment from html
		// doc = alchemyObj.HTMLGetTargetedSentiment(htmlDoc,
		// "http://www.test.com/", "WujWuj", sentimentParams);
		// System.out.print(getStringFromDocument(doc));
}
