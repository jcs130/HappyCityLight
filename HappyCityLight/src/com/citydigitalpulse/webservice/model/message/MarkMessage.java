...
public class MarkMessage {
	...
	public String toString() {
		return "MarkMessage [msg_id=" + msg_id + ", text=" + text
				+ ", first_media_url=" + first_media_url + ", mark_time="
				+ mark_time + ", emotion_text=" + emotion_text
				+ ", emotion_first_media=" + emotion_first_media + ", lang="
				+ lang + ", message_from=" + message_from + "]";
	}
