...
public class ServerConfig {
	...
	// password = "jcsss130";
	 ...
	 // 用于存储缓存的服务器地址
	 public static String CACHE_ADDR = "citypulse1.site.uottawa.ca";
...
//	public static int CACHE_PORT = 6379;
	...
	// 用于存储网站用户信息的数据库
	public static String WEB_SERVER_DATABASE_URL = "jdbc:mysql://citypulse1.site.uottawa.ca:3306/digitalcity?useSSL=false";
	public static String WEB_SERVER_DATABASE_USER_NAME = "jcs130";
	public static String WEB_SERVER_DATABASE_USER_PASSWORD = "jcsss130";

	// 用于存储人工标注的训练数据的数据库
	public static String TRAINING_DATABASE_URL = "jdbc:mysql://citypulse1.site.uottawa.ca:3306/digitalcity?useSSL=false";
