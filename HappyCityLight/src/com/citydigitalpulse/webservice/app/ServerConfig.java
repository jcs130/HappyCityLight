...
public class ServerConfig {
	...
	// 用于存储结构化后的数据的数据库
	public static String MESSAGE_SAVING_DATABASE_URL = "jdbc:mysql://aadnpbvnceozrn.cqkitdz1e3ma.us-west-2.rds.amazonaws.com:3306/msgsaving?useSSL=false";
	...
	// 用于存储网站用户信息的数据库
	public static String WEB_SERVER_DATABASE_URL = "jdbc:mysql://aadnpbvnceozrn.cqkitdz1e3ma.us-west-2.rds.amazonaws.com:3306/digitalcity?useSSL=false";
	public static String WEB_SERVER_DATABASE_USER_NAME = "jcs130";
	public static String WEB_SERVER_DATABASE_USER_PASSWORD = "jcsss130";

	// 用于存储人工标注的训练数据的数据库
	public static String TRAINING_DATABASE_URL = "jdbc:mysql://aadnpbvnceozrn.cqkitdz1e3ma.us-west-2.rds.amazonaws.com:3306/digitalcity?useSSL=false";
	public static String TRAINING_DATABASE_USER_NAME = "jcs130";
	public static String TRAINING_DATABASE_USER_PASSWORD = "jcsss130";

	// 用于存储缓存的服务器地址
	public static String CACHE_ADDR = "cdpservercache.koywr5.0001.usw2.cache.amazonaws.com";
