...
/**
 * Tools for list to string and string to list Including encryption and
 * decryption
 * 
 * @author zhonglili
 *
...
public class Tools {
	...
	public static List<String> buildArrayListFromString(String hashTagText) {
		String[] temp = hashTagText.split(" ");
		ArrayList<String> res = new ArrayList<String>();
		for (int i = 0; i < temp.length; i++) {
			if (!"".equals(temp[i])) {
				res.add(temp[i]);
